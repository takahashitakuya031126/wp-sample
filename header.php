...
<link rel="apple-touch-icon" href="<?php echo get_template_directory_uri(); ?>/images/iphone.png">
<link rel="icon" type="image/png" size="256x256" href="<?php echo get_template_directory_uri(); ?>/images/android.png">
